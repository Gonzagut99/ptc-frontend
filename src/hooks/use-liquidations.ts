 ...
 */
export function useLiquidationById(liquidationId: number, enabled: boolean = true) {
...
export function useAddTourService(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/tour-services', {
        params: {
            path: { liquidationId },
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['get', '/liquidations/{liquidationId}', { liquidationId }] });
            queryClient.invalidateQueries({ queryKey: ['get', '/liquidations/paginated'] });
            toast.success('Servicio de tour agregado correctamente');
        },
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al agregar el servicio de tour';
            toast.error(errorMessage);
        },
    });
}
...
export function useAddHotelService(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/hotel-services', {
        params: {
            path: { liquidationId },
        },
        onSuccess: () => {
        ...
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al agregar el servicio de hotel';
            toast.error(errorMessage);
        },
    });
}
...
export function useAddFlightService(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/flight-services', {
        params: {
            path: { liquidationId },
        },
        onSuccess: () => {
        ...
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al agregar el servicio de vuelo';
            toast.error(errorMessage);
        },
    });
}
...
export function useAddAdditionalService(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/additional-services', {
        params: {
            path: { liquidationId },
        },
        onSuccess: () => {
        ...
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al agregar el servicio adicional';
            toast.error(errorMessage);
        },
    });
}
...
export function useAddPayment(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/payments', {
        ...
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al registrar el pago';
            toast.error(errorMessage);
        },
    });
}
...
export function useAddIncidency(liquidationId: number) {
    ...
    return backend.useMutation('post', '/liquidations/{liquidationId}/incidencies', {
        params: {
            path: { liquidationId },
        },
        onSuccess: () => {
        ...
        onError: (error: any) => {
            const errorMessage = error?.message || 'Ocurrió un error al reportar la incidencia';
            toast.error(errorMessage);
        },
    });
}
